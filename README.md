# Spectral data from microplastic weathering studies

This repository contains the data corresponding to the manuscript [The effect of weathering environments on microplastic chemical identification with Raman and IR spectroscopy: Part II. Polystyrene, polyethylene terephthalate, and nylon 6](https://pubs.rsc.org/en/content/articlehtml/2026/sm/d5sm01102g) (DOI: 10.1039/D5SM01102G).
...
## The spectral data is organized as follows: 

### Air weathering: 

Polystyrene (PS) 31.X series

Polyethylene terephthalate (PET) 32.X series

Nylon 6 (PA6) 33.X series
...
### Artificial seawater weathering: 

PS 45.X series

PET 46.X series 

PA6 weathered 47.X series 

### Puget Sound seawater weathering: 
...
for 2 (XX.1), 4 (XX.2), 6 (XX.3), 8 (XX.4), 10 (XX.5), and 26 (XX.6) weeks 
